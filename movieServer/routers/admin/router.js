module.exports = app => {
    ...
    router.get('/movies/create', async (req, res) => {
        // 创建 电影 数据
        let movie = Array(8).fill().map((_, i) => {
            return {
                name: "少年的你",
                director: '曾国祥',
                protagonist: '周冬雨 / 易烊千玺 / 尹昉 / 周也 / 吴越 / 黄觉 / 张艺凡 / 张耀 / 张歆怡 / 赵润南 / 郜玄铭 / 谢欣桐 / 刘然 / 何廖侣匀 / 胖虎 / 罗俊林',
                poster: '',
                cover: '',
                trailer: '',
                scroe: 8.4,
                movieType: '剧情 / 爱情 / 犯罪',
                originalName: '少年的你，如此美丽 / Better Days',
                producerPlace: '中国大陆',
                language: '汉语普通话',
                releaseDate: '2019-10-25(中国大陆)',
                totalTime: '135分钟',
                plotDesc: '　陈念 （周冬雨 饰）是一名即将参加高考的高三学生，同校女生胡晓蝶（张艺凡 饰）的跳楼自杀让她的生活陷入了困顿之中。胡晓蝶死后，陈念遭到了以魏莱（周也 饰）为首的三人组的霸凌，魏莱虽然表面上看来是乖巧的优等生，实际上却心思毒辣，胡晓蝶的死和她有着千丝万缕的联系。一次偶然中，陈念邂逅了名为小北（易烊千玺 饰）的小混混，随着时间的推移，心心相惜的两人之间产生了真挚的感情。小北答应陈念在暗中保护她免受魏莱的欺凌，没想到这一决定引发了一连串的连锁反应。负责调查胡晓蝶死因的警官郑易（尹昉 饰）隐隐察觉到校园里的古怪气氛，可他的调查却屡屡遭到校方的阻挠。'
            }
        })
        console.log(movie)
